      ...
      <div className="flex items-center justify-center lg:flex-row sm:flex-col">
        <div className="flex flex-col lg:gap-40 sm:gap-10 justify-center flex-wrap">
          <div className="flex flex-col justify-start items-start gap-2">
            <img
              src="src/assets/features-1/Icon.svg"
              alt=""
              className="max-h-12"
            />
          ...
          <div className="flex flex-col justify-start items-start gap-2">
            <img
              src="src/assets/features-1/Icon-1.svg"
              alt=""
              className="max-h-12"
            />
            <p className="bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent font-black text-xl">
        ...
        <div className=" lg:block hidden">
          <img
            src="src/assets/features-1/Illustration.svg"
            alt=""
        ...
        <div className="flex flex-col lg:gap-40 sm:gap-10 justify-center flex-wrap">
          <div className="flex flex-col justify-start items-start gap-2">
            <img
              src="src/assets/features-1/Icon-2.svg"
              alt=""
              className="max-h-12"
            />
            <p className="bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent font-black text-xl">
          ...
          <div className="flex flex-col justify-start items-start gap-2">
            <img
              src="src/assets/features-1/Icon-3.svg"
              alt=""
              className="max-h-12"
            />
            <p className="bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent font-black text-xl">
