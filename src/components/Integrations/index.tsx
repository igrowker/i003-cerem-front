  ...
  return (
    <div className="flex flex-col justify-center items-center p-8 min-h-screen bg-cover bg-center">
      <h2 className="text-4xl font-bold text-white mb-12 text-center">
        {t("Integrado con las redes sociales Integrado con las redes sociales")}
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="bg-white rounded-lg shadow-lg overflow-hidden w-[285px] h-[342px]">
          <CardContent className="pt-6">
            ...
            <h3 className="text-xl font-semibold text-center mb-2 text-[#006FBA]">
              Facebook
            </h3>
            <p className="text-gray-600 text-center px-4">
              {t(
                "Gestiona y analiza tus campañas de Facebook directamente desde nuestra plataforma."
              )}
              .
            </p>
          </CardContent>
        ...
        <Card className="bg-white rounded-lg shadow-lg overflow-hidden w-[285px] h-[342px]">
          <CardContent className="pt-6">
            ...
            <p className="text-gray-600 text-center px-4">
              {t(
                "Integra y controla tus acciones en Twitter para alcanzar tus objetivos de marketing"
              )}
            </p>
          </CardContent>
          <CardFooter className="flex justify-center">
        ...
        <Card className="bg-white rounded-lg shadow-lg overflow-hidden w-[285px] h-[342px]">
          <CardContent className="pt-6">
            ...
            <p className="text-gray-600 text-center px-4">
              {t(
                "Potencia tus campañas en Google con una visión integral de su desempeño."
              )}
            </p>
          </CardContent>
          <CardFooter className="flex justify-center">
